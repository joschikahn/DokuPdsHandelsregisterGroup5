...
#### Umsetzung:
  ...
  *  Die Organisation wird anhand der Beschreibung der best-passendesten Branche zugeordnet (diejenige mit dem höchsten Similariy-Wert). Die top 5 Branchen werden zu der Organisation zugeordnet werden und damit alle Firmen klassifiziert werden. 
